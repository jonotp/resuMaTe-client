  ...
  return (
    <div className="resume-builder">
      <Switch>
        ...
        <Route path={path + ROUTES.RESUME_BUILDER.PERSONAL} render={(props) => (<Personal {...props} state={personalDetails} setState={setPersonalDetails} onContinue={nextPage} onPageLoad={onPageLoad} />)} />
